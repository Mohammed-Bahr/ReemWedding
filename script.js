...
document.addEventListener('DOMContentLoaded', () => {
  ...
  musicBtn.addEventListener('click', function onClick() {
    ...
    /* بدء التمرير التلقائي بعد ظهور آخر جملة من الافتتاح بوقت كافٍ للقراءة */
    setTimeout(() => { window.__startAutoScroll && window.__startAutoScroll(); }, 8200);
  }, { once: true });
...
/* ============================================================
   7) التمرير التلقائي للصفحة
   ------------------------------------------------------------
   تنزلق الصفحة للأسفل تلقائيًا وبلطف لتتيح للضيف قراءة الدعوة
   دون الحاجة لتمريرها بنفسه. بمجرد أن يقوم الزائر بأي تمرير أو
...
(function autoScrollSetup() {
  ...
  window.__startAutoScroll = start;
})();
